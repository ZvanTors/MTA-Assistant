...
<p>Rank-based factions (Medic, Hitman Agency, Taxi) support <strong>5 ranks</strong>, each with its own price list. Pick your rank once — it's remembered forever.</p>
...
└── screenshots/
    ...
    ├── Wanted/
    └── ...</code></pre>
<p>Folder names are matched <strong>case-insensitively</strong>. Missing folders are handled gracefully — no errors.</p>
...
<h3>v1.6.0</h3>
<ul><li>🚕 <strong>Taxi</strong> faction added with rank-based Service pricing (Shift is fixed across all ranks)</li></ul>
...
<h3>v1.3.0</h3>
<ul><li>👮 <strong>Police Department</strong> faction added (with optional <code>Ticket</code> category)</li></ul>
